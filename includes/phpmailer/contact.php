...
function init_mail()
{
	$host = 'mail.themina.net';			// Set the hostname of the mail server
	$port = 25;						// Set the SMTP port number - likely to be 25, 465 or 587
	$username = 'noreply@themina.net';	// Username to use for SMTP authentication
	$password = '123QWE!@#';			// Password to use for SMTP authentication
